...
import cat.ejdrs.jh.photo_bird.config.audit.AuditEventConverter;
import cat.ejdrs.jh.photo_bird.domain.PersistentAuditEvent;
...
import static cat.ejdrs.jh.photo_bird.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
